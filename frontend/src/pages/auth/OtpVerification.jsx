...
import { Zap, ArrowLeft, ShieldCheck, RefreshCw, CheckCircle2 } from 'lucide-react';
        ...
        <div className="glass-card p-7 glow-primary">
          {verified ? (
            ...
            <div className="text-center py-6">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/30 mb-4 animate-bounce-in">
